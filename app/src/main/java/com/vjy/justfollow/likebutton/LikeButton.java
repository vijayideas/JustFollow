...
public class LikeButton extends FrameLayout implements View.OnClickListener {
    ...
    private FeedRecyclerAdapter.ViewHolder viewHolder;
    ...
    public void onClick(View v) {
        ...
        if (likeListener != null) {
            if (isChecked) {
                likeListener.liked(this,this.viewHolder);
            } else {
                likeListener.unLiked(this,viewHolder);
            }
        }
    ...
    public void setOnLikeListener(OnLikeListener likeListener, FeedRecyclerAdapter.ViewHolder holder) {
        this.likeListener = likeListener;
